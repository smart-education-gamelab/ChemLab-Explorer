		...
		public void OnGUI()
		{
			...
			GUILayout.BeginHorizontal();
				...
				EditorGUILayout.LabelField(
					"Currently installed: Version 1.98.5 for Unity 2022.3.20 LTS and URP 14.0.10", _style_bodytxt);
				GUILayout.Space(16);
			GUILayout.EndHorizontal();
			...
			GUILayout.BeginHorizontal();
				GUILayout.Space(16);
				EditorGUILayout.LabelField(
					"The package you have downloaded from the asset store installed shaders compatible with URP 14.0.10. " + 
